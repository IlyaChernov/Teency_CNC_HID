...
void TeensyCNCCore::ExecuteCode(String code)
{
  ...
  {
    global_state.cnc_speeds.movement_speed = code.remove(0, 1).replace(",", ".").toFloat();
...
void TeensyCNCCore::report_state()
{
  ...
  b = (byte *)&global_state.cnc_status.line_number;
  ...
  int queueLength = global_state.USBCMDqueueSTR.length();
  b = (byte *)&queueLength;
  ...
  b = (byte *)&global_state.cnc_status.engine_state;
